export type skill = { name: string, icon_name: string, category: string, text1: string, text2: string };
...
export const skills: skill[] = [
    ...
    {
        name: 'GitHub & Git', icon_name: 'github', category: 'Service & Version Control Software', text1: 'いつも使ってます。', text2: '職場にも導入してもらった'
    },
    {
        name: 'Linux (Ubuntu)', icon_name: 'linux', category: 'Operating System', text1: '職場でRHELを強要されかけた', text2: 'アブナイ、、、'
    },
    {
        name: 'Docker', icon_name: 'docker', category: 'Containerization', text1: '部活の大先輩に言われて始めました。', text2: ''
    },
    {
        name: 'TypeScript', icon_name: 'typescript', category: 'Language', text1: '型付けがしっかりしてて', text2: '安心❗'
    },
    {
    ...
    {
        name: 'Firebase', icon_name: 'firebase', category: 'Cloud Platform', text1: '今はHostingを主に利用。', text2: 'Androidアプリでも使ってる。'
    },
    {
